# -*- coding: utf-8 -*-
#
# SSHConfig documentation build configuration file, created by
...
htmlhelp_basename = 'sshconfigdoc'
...
latex_documents = [
  ('index', 'sshconfig.tex', u'SSHConfig Documentation',
...
man_pages = [
    ('index', 'sshconfig', u'SSHConfig Documentation',
     [u'Ken Kundert'], 1)
]
...
texinfo_documents = [
  ('index', 'SSHConfig', u'SSHConfig Documentation',
   u'Ken Kundert', 'SSHConfig', 'One line description of project.',
   'Miscellaneous'),
]
